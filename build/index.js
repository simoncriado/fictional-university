...
class MyNotes {
  ...
  editNote(e) {
    // Here we get the ID from the specific li item that should be deleted
  ...
  } // Small logic to toggle the edit note functionality
...
class Search {
  // 1. Describing and creating/initiating our object
  // Any code we place inside the constructor function will be executed as soon as we create an object using the class
  constructor() {
    this.addSearchHTML();
